...
const InvestReturns = () => {
    ...
    const currency = '$';
    const minInvestAmount = 100, maxInvestAmount = 500000, investAmountStep = 100;
    ...
    useEffect(() => {
        ...
        fetch(`https://basketo-api.herokuapp.com/api/calculate?${ queryParams }`, {
            headers: {
            ...
            >
                ...
                >
                    ...
                    <Typography fontSize="xx-large" fontWeight="bold">
                        {/* { currency + getFormattedAmount(returns) } */}
                        { Math.round(returns) }%
                    </Typography>
